...
import static com.github.wilgaboury.jsignal.rx.RxUtil.batch;
import static com.github.wilgaboury.jsignal.rx.RxUtil.on;
...
public class BasicSignalTest {
  ...
  public void testReadmeExample() {
    ...
    handle = Effect.create(on(squared, (cur, prev) ->
    {
  ...
  public void testBatch() {
    ...
    Effect effect = Effect.create(() -> {
      Effect.create(on(sig1, () -> sig1Count.accept(sig1Count.get() + 1)));
      Effect.create(on(sig2, () -> sig2Count.accept(sig2Count.get() + 1)));

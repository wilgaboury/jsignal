...
public class Layout {
    ...
    public Rect getBorderRect() {
        ...
        var insets = new Insets(getMarginTop(), getMarginRight(), getMarginBottom(), getMarginLeft());
        return insets.shink(rect);    }

    public Rect getPaddingRect() {
        var rect = getBorderRect();
        var insets = new Insets(getBorderTop(), getBorderRight(), getBorderBottom(), getBorderLeft());
        return insets.shink(rect);
    }

    public Rect getContentRect() {
        var rect = getPaddingRect();
        var insets = new Insets(getPaddingTop(), getPaddingRight(), getPaddingBottom(), getPaddingLeft());
        return insets.shink(rect);
    }
